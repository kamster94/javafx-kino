...
public class BiletAdminHistoryPaneController implements Initializable{
	...
	public void fillList(){
		...
		List<String> results = new ArrayList<String>(user.getFields("SELECT * FROM DBA.BiletHistoria", columns));
