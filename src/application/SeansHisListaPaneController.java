...
public class SeansHisListaPaneController implements Initializable{
	...
	public void fillList(){
		List<String> params = new ArrayList<String>(this.user.getFields("SELECT * FROM DBA.Seans WHERE czyArchiwalna = 1", columnsList));
