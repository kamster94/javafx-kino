...
public class BiletHistoryPaneController implements Initializable{
	...
	public void fillList(){
		...
		columns.add("IDKina");
		List<String> results = new ArrayList<String>(user.getFields("SELECT * FROM DBA.BiletHistoria WHERE IDUzytkownika = " + user.id, columns));
		int count = user.getInt("SELECT COUNT(*) FROM DBA.BiletHistoria WHERE IDUzytkownika = " + user.id);
